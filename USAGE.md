...
Este ficheiro é o guia completo de exploração do projeto. Basta seguir as secções abaixo para testar todas as funcionalidades implementadas.
...
USAGE.md           guia completo de instalação, exploração e demonstração
```
